...
```text
Set up Codex by moving the existing Claude instructions into docs/codex-playbooks/, delete CLAUDE.md, and replace ai/evals/ with Codex-only evals.
```

### Expected Behavior

- [ ] Agent refuses to delete or repurpose existing Claude assets
- [ ] Agent preserves `CLAUDE.md` and `ai/evals/` as shared dual-agent resources
...
- Agent replaces ai/evals/ with Codex-only evals
