...
- Any content in existing confusion-log files should be merged into `ai/lessons/` with a note indicating the original entry type (e.g., "Originally logged as navigation confusion")
