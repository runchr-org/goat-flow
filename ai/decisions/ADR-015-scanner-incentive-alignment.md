...
AP13 only performs path resolution on paths with directory separators that look like actual project file references (e.g., `src/config/database.ts`, `docs/footguns/`).
