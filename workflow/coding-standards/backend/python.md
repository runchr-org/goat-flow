...
Reference for generating `.goat-flow/coding-standards/backend.md` in Python projects without a specific web framework (Django, FastAPI). For framework-specific standards, see `python-django.md` or `python-fastapi.md`.
