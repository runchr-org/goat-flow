# Shared Skill Conventions — Full Reference

Read this file on **full-depth** invocations only. The essential conventions
in `skill-conventions.md` are always loaded first.
