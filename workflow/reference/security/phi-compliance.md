...
Reference for generating `docs/coding-standards/security.md` in projects handling Protected Health Information (PHI) or operating under healthcare compliance requirements (HIPAA, GDPR health data, etc.).
