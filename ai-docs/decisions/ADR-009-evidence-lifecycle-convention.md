...
This is a framework-wide convention. The canonical description originally lived in `docs/system-spec.md` under the learning loop section (retired in v1.1.0; see `workflow/setup/shared/phase-1.md` for learning loop guidance).
