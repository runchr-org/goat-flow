...
Harness checks are grouped by **concern** -- the six things that matter for agent effectiveness. See [harness-engineering.md](harness-engineering.md) for what each concern means and the sources behind the model.

**harness scope** (AI Harness Completeness) - 18 checks across 6 concerns:
...
- **Workspace Boundary** (2) - boundary guidance present, boundary path separation
