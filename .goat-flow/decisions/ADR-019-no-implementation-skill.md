...
- The execution loop (`docs/system-spec.md:154`, `docs/system-spec.md:185`, retired in v1.1.0; see `workflow/setup/execution-loop.md`) already defines Implement as a core execution mode
