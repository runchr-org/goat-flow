...
- `ai-docs/lessons/` - agent behavioral mistakes
- `ai-docs/footguns/` - architectural traps with file:line evidence
...
- `ai-docs/architecture.md` - system orientation for agents
