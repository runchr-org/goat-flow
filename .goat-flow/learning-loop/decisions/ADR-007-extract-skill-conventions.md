# ADR-007: Extract shared skill conventions to .goat-flow/skill-docs/skill-conventions.md
...
Extract shared conventions from inline in each skill to a single file: `.goat-flow/skill-docs/skill-conventions.md`. Setup copies this from `workflow/skills/reference/skill-conventions.md`.
