# Shared Skill Conventions — Essential

All goat-* skills follow these shared conventions. This file contains the
essential conventions read on every skill invocation. For full-depth work,
also read `skill-conventions-full.md`.
