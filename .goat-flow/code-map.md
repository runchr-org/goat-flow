...
│   ├── hook-lib/                = deny-dangerous policy modules and self-test templates
...
├── hook-lib/                    = committed deny-dangerous policy modules and self-test
├── skill-reference/             = installed shared skill preamble/conventions
...
├── skill-playbooks/             = installed standalone tool/capability playbooks
...
│   ├── skill-quality-testing.md = short index for skill-authoring methodology
...
├── tasks/                       = local milestone/plan files; gitignored except anchors
