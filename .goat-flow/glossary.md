...
|------|-----------|----------------|---------|
| Anti-Pattern Deduction | Removed in v1.1.0. Was a scored penalty system (AP1-AP23) applied by the scanner/rubric engine. Replaced by advisory quality checks in `src/cli/audit/harness/`. | — | — |
...
| Mob Elaboration | A planning phase where a feature brief is stress-tested from multiple perspectives before implementation. Replaced by goat-sbao for multi-perspective critique. | -- | -- |
...
| Triangular Tension | A mob elaboration technique that stress-tests a plan from three competing perspectives to surface hidden risks. Now part of goat-sbao. | -- | -- |
