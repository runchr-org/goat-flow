...
| CLI auditor | `src/cli/` | 17 build checks (13 setup scope + 4 agent scope) + 18 AI harness installation checks (6 concerns), audit-driven setup prompts, quality prompt/history/diff surfaces, multi-agent support |
