...
## Decision
Keep the canonical definition in `ai-docs/architecture.md` and make every secondary surface either point to it or carry only a compressed hot-path summary.
